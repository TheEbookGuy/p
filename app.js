...
function footer(){document.write(`<footer class="footer">Urban Mining Connect • Prototype aligned to the supplied Kabadiwala Connect PRD • Demo/seed rates and facilities are illustrative, not live regulatory or market data.</footer>`)}
